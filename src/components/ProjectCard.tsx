...
const ProjectCard = (props: any) => {
    ...
    return (
      ...
      >
        <Card
          onClick={open}
          className="!bg-bgColor cursor-pointer transition-transform duration-300 ease-in-out hover:!scale-[1.02] mb-5 hover:!shadow-[0_0_10px_1px_#8A2BE280] xs-mx:!shadow-[0_0_10px_1px_#8A2BE280] !border-primaryColor border-2"
          shadow="lg"
          padding="sm"
          radius="lg"
          withBorder
