...
const Projects=()=>{
    return (
        <div className="px-16  my-10 font-mono md-mx:px-6" id="Projects">
            <h1 className="m-10 text-5xl sm-mx:text-3xl xs-mx:text-2xl mb-10 font-bold text-white"><span className="text-primaryColor"></span>Projects</h1>
            <div className="flex flex-wrap justify-around md-mx:justify-between sm-mx:justify-center gap-4 md-mx:gap-2 m-5">
                {
